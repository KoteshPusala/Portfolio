      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden w-full glass-nav-light dark:glass-nav-dark overflow-hidden absolute top-full left-0 shadow-lg border-t border-premiumLight-border dark:border-premiumDark-border z-50"
          >
